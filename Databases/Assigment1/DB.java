  ...
  public boolean open(String filename) {
    ...
    try {
      if(!this.isOpen)
      {
        ...
        this.config = new RandomAccessFile("./colleges_lf.config", "rw");
        this.data = new RandomAccessFile("./colleges_lf.data", "rw");
        this.overflow = new RandomAccessFile("./colleges_lf.overflow", "rw");
        this.isOpen = true;
        return true;
      }
      else
